...
security unlock-keychain -p mymacpassword     /Users/niuxinghua/Library/Keychains/login.keychain

security import ${P12_Path}.p12 -k /Users/niuxinghua/Library/Keychains/login.keychain -P p12的密码 -T /usr/bin/codesign

mobileprovisionName="kakaxi"
mobileprovision_file="/Users/niuxinghua/Desktop/ios/证书/kakaxi/${mobileprovisionName}.mobileprovision"
